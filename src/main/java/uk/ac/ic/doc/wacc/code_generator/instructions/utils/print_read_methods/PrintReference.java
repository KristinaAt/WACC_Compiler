...
public class PrintReference extends AbstractUtilMethod {

  public PrintReference(String msg_label) {
    super();
     /* Generates the label for printing a reference and pushes the
        return address onto the stack */
    this.instructions.add(new Label(p_print_reference.toString()));
